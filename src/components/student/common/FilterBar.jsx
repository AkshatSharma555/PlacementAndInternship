...
const FilterBar = () => {
  const filters = ["All Domains", "All Types", "Any modes", "Any Location"];
  return (
    <div className="bg-white p-4 rounded-xl shadow-md flex items-center gap-4">
      ...
      <button className="bg-[#00A99D] text-white font-semibold py-2 px-6 rounded-md hover:bg-opacity-90">Apply Filter</button>
    </div>
  );
};
